...
# modified 09/09/2025 to report max_depth correctly
...
def locate_exe(submission):
    ...
    # not where 412fe lives (e.g., the submission includes a copy of
    # the simulator source code or something similar), then it is below
    # the point in the directory tree where it will find 412fe
    # So, 
    os.chdir(subDir)
